...
public class HabitTypeTest {
    ...
    public void getTitle() throws Exception {
        HabitType h1 = new HabitType("test1", "eating less", "coming close to morbid obesity", new Date(), new ArrayList<Boolean>());
    ...
    public void getStartDate() throws Exception {
        Date d = new Date();
        HabitType h1 = new HabitType("test1", "eating less", "coming close to morbid obesity", d, new ArrayList<Boolean>());
...
//        HabitEvent he2 = new HabitEvent(h1, "Didnt really compelte my habit but im still going to add to my habit event");
    ...
    public void setWeekdays() throws Exception {
        HabitType h1 = new HabitType("test1", "eating less", "coming close to morbid obesity", new Date(), new ArrayList<Boolean>());
        ArrayList<Boolean> wkdy = new ArrayList<Boolean>();
        wkdy.add(false); wkdy.add(true); wkdy.add(false);
        h1.setWeekdays(wkdy);
    ...
    public void setEvents() throws Exception {
        HabitType h1 = new HabitType("test1", "eating less", "coming close to morbid obesity", new Date(), new ArrayList<Boolean>());
        HabitEvent he1 = new HabitEvent("h1JSONstring", "I bought a whole pizza today. I only ate 7 slices");
        HabitEvent he2 = new HabitEvent("h1JSONstring", "Didnt really compelte my habit but im still going to add to my habit event");
    ...
    public void equals() throws Exception {
        HabitType h1 = new HabitType("test1", "eating less", "coming close to morbid obesity", new Date(), new ArrayList<Boolean>());
        HabitType h2 = new HabitType("test1", "eating less", "coming close to morbid obesity", new Date(), new ArrayList<Boolean>());
